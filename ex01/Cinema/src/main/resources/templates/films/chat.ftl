...
<div class="container">
    ...
    <hr>
    <h3 class="h3 mb-3"><@spring.message code="chat"/></h3>
    <div id="chat-page" class="hidden card chat-container row">
        <div class="connecting">
            <h3 class="h3 text-center pt-3">
                    ...
                    <#if model["Messages"]?has_content>
                        <#list model["Messages"] as msg>
                            <#if msg.userName==model["Name"]>
                                ...
                                <#assign pos="right" text="text-end" />
                            <#else>
                ...
                <div class="form-group flex-grow-0 py-3 px-4 border-top">
                    <div class="input-group clearfix">
                        ...
                        <input type="text" id="message" autocomplete="off" class="form-control"
                               placeholder="<@spring.message code="chat.placeholder"/>">
                        <button type="submit" class="btn btn-primary"><@spring.message code="chat.send"/></button>
                    </div>
                </div>
            </form>
